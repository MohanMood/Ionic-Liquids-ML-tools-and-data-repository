...
GBTModel = GradientBoostingRegressor(loss='squared_error', learning_rate=0.03, n_estimators=500, 
                          subsample=0.6, criterion='friedman_mse', min_samples_split=3, 
                          min_samples_leaf=1, min_weight_fraction_leaf=0.005, max_depth=5, 
                          min_impurity_decrease=0.0, init=None, random_state=205, 
